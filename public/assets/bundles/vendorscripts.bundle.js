                ...
                return (
                    this.each(function () {
                        ...
                        function e(a, b, c) {
                            ...
                            if (
                                (b && ((e = parseInt(z.css("top")) + ((a * parseInt(d.wheelStep)) / 100) * z.outerHeight()), (e = Math.min(Math.max(e, 0), f)), (e = a > 0 ? Math.ceil(e) : Math.floor(e)), z.css({ top: e + "px" })),
                        ...
                        if (u.parent().hasClass(d.wrapperClass)) {
                            ...
                            z
                                ...
                                f(),
                                "bottom" === d.start ? (z.css({ top: u.outerHeight() - z.outerHeight() }), e(0, !0)) : "top" !== d.start && (e(a(d.start).position().top, null, !0), d.alwaysVisible || z.hide()),
                                (function (a) {
